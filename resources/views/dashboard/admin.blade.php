    ...
    <x-container>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Teachers Management</h3>
                    <p class="text-gray-600 dark:text-gray-400 mb-4">Manage all teachers and their information</p>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mb-4">Manage all students and their information</p>
