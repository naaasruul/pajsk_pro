                    ...
                    <form method="POST" action="{{ route('students.update', $student) }}" class="space-y-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="border-b border-gray-900/10 pb-6">
                                ...
                                <div class="flex flex-wrap -mx-2">
                                    ...
                                    <div class="w-full md:w-1/4 px-2 mt-4">
                                        ...
                                        <select id="year-select" name="year"
                                            ...
                                            @foreach ($classroomsGrouped as $year => $classes)
                                                <option value="{{ $year }}"
                                                    @if (isset($student->classroom) && $student->classroom->year == $year) selected @endif>
                                                    {{ $year }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="w-full md:w-3/4 px-2 mt-4">
                                        ...
                                        <select id="classroom-select" name="class_id"
                                            class="mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            required disabled>
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="phone_number" name="phone_number" type="text"
                                        class="mt-1 block w-full" :value="old('phone_number', $student->phone_number)" required />
                            ...
                            <div class="border-b border-gray-900/10 pb-6">
                                ...
                                <div class="flex flex-wrap -mx-2">
                                    <div class="w-full md:w-1/4 px-2 mt-4">
                                        <x-input-label for="teacher-select" :value="__('Teacher Name')" />
                                        <select id="teacher-select" name="teacher_id"
                                            ...
                                            @foreach ($teachers as $teacher)
                                                <option value="{{ $teacher->id }}"
                                                    @if (old('teacher_id', $student->mentor_id) == $teacher->id) selected @endif>
                                                    {{ $teacher->user->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="w-full md:w-3/4 px-2 mt-4 flex items-center">
                                        @if ($student->mentor_id)
                                            @php
                                                $currentMentor = $teachers->where('id', $student->mentor_id)->first();
                                            @endphp
                                            <span class="text-sm text-gray-700 dark:text-gray-200">
                                                <strong>Current Homeroom Teacher:</strong>
                                                {{ $currentMentor ? $currentMentor->user->name : 'N/A' }}
                                            </span>
                                        @else
