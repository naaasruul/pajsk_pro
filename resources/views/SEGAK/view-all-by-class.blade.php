<x-app-layout>
    ...
    <x-container>
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg print:hidden">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <div class="relative overflow-x-auto print:overflow-visible">
                    <table
                        class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 print:text-black print:border print:border-black">
                        <thead
                            class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 print:bg-white print:text-black print:border-b print:border-black">
                            <tr>
