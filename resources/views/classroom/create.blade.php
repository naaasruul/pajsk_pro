                        ...
                        <form method="POST" action="{{ route('classrooms.store') }}" class="space-y-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="border-b border-gray-900/10 pb-6">
                                    ...
                                    <div x-show="year && class_name" class="mt-4 text-sm text-blue-700 dark:text-blue-300">
                                        <span x-text="`${year} ${class_name} will be created.`"></span>
                                    </div>
                                </div>
                            </div>
